...
public class OrderDTO {
	...
	public String toString() {
		return "OrderDTO [idx=" + idx + ", order_code=" + order_code + ", item_code=" + item_code + ", order_status="
				+ order_status + ", order_date=" + order_date + ", order_amount=" + order_amount + ", order_name="
				+ order_name + ", order_phone=" + order_phone + ", receive_name=" + receive_name + ", receive_phone="
				+ receive_phone + ", receive_address=" + receive_address + ", receive_address_detail="
				+ receive_address_detail + ", memo=" + memo + ", order_price=" + order_price + ", order_color="
				+ order_color + ", order_size=" + order_size + ", payment_type=" + payment_type + ", trade_payer="
				+ trade_payer + ", payment_date=" + payment_date + ", user_email=" + user_email + "]";
	}
