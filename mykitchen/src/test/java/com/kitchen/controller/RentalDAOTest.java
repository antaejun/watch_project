...
public class RentalDAOTest {
	...
	/*
	 * @Test public void testRegist() throws Exception{ // 객체 정보 생성 RentalVO vo =
	 * new RentalVO(); vo.setTitle("새글 작성하기(서비스)");
	 ...
	 * //페이지 번호 int page = 1;
	 * 
	 * // List<RentalVO> RentalList = rdao.listPage(page); // // for(RentalVO vo
	 * :RentalList) { // System.out.println(vo.getidx()+" -> "+vo.getTitle()); // }
	 * }
	 */
	 ...
	 * 
	 * // dao 호출 ListRentalnVO> RentalList = rdao.listPage(cri);
	 * 
