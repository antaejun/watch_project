...
public class RentalDAOImpl implements RentalDAO {
	...
	private static final String namespace=
			"com.kitchen.mapper.RentalMapper";
	
	@Override
	public void create(RentalVO vo) throws Exception {
		// 게시판 글 등록
		System.out.println("@@@@@ BoardDAOImpl 객체 호출 -> Mapper이동 SQL 실행 ");
...
//		// 글 삭제 동작 처리 
//		System.out.println("@@@@@  서비스_removeBoard()에서 호출");
...
//		}
//
//		// Mapper에서 데이터를 limit 위치,개수
//		// 0(1페이지),10(2페이지),20(3페이지),..... => #{page}
//		page = (page - 1) * 10;
//		
