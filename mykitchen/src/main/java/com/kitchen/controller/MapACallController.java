...
@Controller
@RequestMapping("/MapACall/*")
public class MapACallController {
		...
		public void MapGET(@ModelAttribute("Map") String Map, Model model) throws Exception {
		...
		@RequestMapping(value = "/MapACall", method = RequestMethod.GET)
		public void MapACallGET(@ModelAttribute("MapACall") String MapACall, Model model) throws Exception {
			logger.info(" 글쓰기 완료후 글 목록페이지 요청(GET) ");
			logger.info("MapACall "+MapACall);
