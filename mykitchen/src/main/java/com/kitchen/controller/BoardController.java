...
import com.kitchen.service.BoardService;
	...
	// 게시물 조회
		...
		// 게시물 수정
			...
			// 게시물 삭제
			  ...
			  public void getDelete(@RequestParam("num") int num, Model model) throws Exception {
			...
			// 게시물 삭제
				...
				public String getDelete(BoardVO vo) throws Exception {
				  service.delete(vo);
